 ...
 */
void MergeSort::swap(std::vector<unsigned int>& array, unsigned int idx1, unsigned int idx2) noexcept
{
 ...
 */
void MergeSort::sort(std::vector<unsigned int>& array, sf::RenderWindow& window) noexcept
{
    int i, j, min;
